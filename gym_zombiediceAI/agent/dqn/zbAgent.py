...
class DQN(Agent):
    ...
    def __init__(self, model, actions, optimizer=None, policy=None, test_policy=None,
                 memsize=10_000, target_update=10, gamma=0.99, batch_size=128, nsteps=8,
        ...
        # If using PrioritizedExperienceReplay, the loss function also computes the TD error and
        # updates the trace priorities
