...
from huskarl.policy import EpsGreedy, Greedy, GaussianEpsGreedy
from huskarl.core import Agent, HkException
from huskarl.memory import ExperienceReplay, PrioritizedExperienceReplay
...
class DQN(Agent):
	...
	def __init__(self, model, actions, optimizer=None, policy=None, test_policy=None,
				 memsize=100000, target_update=10, gamma=0.99, batch_size=32, nsteps=0,
				 enable_double_dqn=False, enable_dueling_network=False, dueling_type='avg'):
		"""
